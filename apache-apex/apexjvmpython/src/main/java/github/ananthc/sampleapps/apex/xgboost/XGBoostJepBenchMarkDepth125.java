 ...
 */
public class XGBoostJepBenchMarkDepth125
{

  @Benchmark
  @BenchmarkMode(Mode.AverageTime) @OutputTimeUnit(TimeUnit.MICROSECONDS)
  public void testXGBoostPredictIrisDepth125(JepHandle jepHandle, Blackhole sink, IrisScoringInputData input)
    throws Exception {
    jepHandle.getJepInstance().set("input",input.getNd());
    jepHandle.getJepInstance().eval("res = booster125.predict(xgb.DMatrix(input))");
