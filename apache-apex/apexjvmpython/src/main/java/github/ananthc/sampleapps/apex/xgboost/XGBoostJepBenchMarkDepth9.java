 ...
 */
public class XGBoostJepBenchMarkDepth9
{


  @Benchmark
  @BenchmarkMode(Mode.AverageTime) @OutputTimeUnit(TimeUnit.MICROSECONDS)
  public void testXGBoostPredictIrisDepth9(JepHandle jepHandle, Blackhole sink, IrisScoringInputData input)
    throws Exception {
    jepHandle.getJepInstance().set("input",input.getNd());
    jepHandle.getJepInstance().eval("res = booster9.predict(xgb.DMatrix(input))");
